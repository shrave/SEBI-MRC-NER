...
class SebiProcessor(QueryNERProcessor):
    def get_labels(self, ):
        return ["Legal Doc", "Object-General", "Subject-Individual", "Subject-Organization", "Authority", "Value", "Objective", "Transaction", "Legal Term", "Date/Time", "Penalty", "O"]
