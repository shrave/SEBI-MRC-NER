...
from data_loader.mrc_data_processor import Conll03Processor, MSRAProcessor, Onto4ZhProcessor, Onto5EngProcessor, GeniaProcessor, ACE2004Processor, ACE2005Processor, ResumeZhProcessor, SebiProcessor
...
def args_parser():
    ...
    parser.add_argument("--saved_model", type=str, default="/home/")
            ...
            if nb_tr_steps % config.checkpoint == 0:
                ...
                if tmp_dev_f1 > dev_best_f1 :
                    ...
                    if config.export_model:
                        ...
                        output_model_file = os.path.join(config.output_dir, "bert_finetune_model_{}_{}.pt".format(str(idx),str(nb_tr_steps)))
                        #torch.save(model_to_save.state_dict(), output_model_file)
                        torch.save({'epoch': idx,'model_state_dict': model.state_dict(),'optimizer_state_dict': optimizer.state_dict(),'loss': loss.item(), }, output_model_file)
