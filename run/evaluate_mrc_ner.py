...
from metric.mrc_ner_evaluate  import flat_ner_performance, nested_ner_performance, nested_ner_prediction
...
def eval_checkpoint(model_object, eval_dataloader, config, \
    ...
    ner_cate_lst = []
    eval_dataloader = eval_dataloader[0]
...
def show_outputs(model_object, eval_dataloader, config, \
    device, n_gpu, label_list, eval_sign="test"):
